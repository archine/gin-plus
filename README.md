![](https://img.shields.io/badge/version-v2.0.1-green.svg) &nbsp; ![](https://img.shields.io/badge/builder-success-green.svg) &nbsp;
...
- Get
```bash
go get github.com/archine/gin-plus/v2@v2.0.1
```

- Mod
```bash
# go.mod文件加入下面的一条
github.com/archine/gin-plus/v2 v2.0.1
