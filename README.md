![](https://img.shields.io/badge/version-v1.0.2-green.svg) &nbsp; ![](https://img.shields.io/badge/builder-success-green.svg) &nbsp;
...
```shell
go get github.com/archine/gin-plus@v1.0.2
```
...
```shell
# go.mod文件加入下面的一条
github.com/archine/gin-plus v1.0.2
# 命令行在该项目目录下执行
go mod tidy
```
