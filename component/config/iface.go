...
type Configure interface {
	// GetBoolean retrieves a boolean value for the given key, returns error if key not found
	GetBoolean(s string) (bool, error)

	// GetBooleanOrDefault retrieves a boolean value for the given key, returns defaultValue if key not found
	GetBooleanOrDefault(s string, defaultValue bool) bool
